...
export default class MsGraphMailMessageBuilder {
    ...
    addBccRecipients(emailAddresses: Array<MsGraphMailEmailAddress | string>): this;
    addCcRecipient(emailAddress: MsGraphMailEmailAddress | string): this;
    addCcRecipients(emailAddresses: Array<MsGraphMailEmailAddress | string>): this;
    addToRecipient(emailAddress: MsGraphMailEmailAddress | string): this;
    addToRecipients(emailAddresses: Array<MsGraphMailEmailAddress | string>): this;
